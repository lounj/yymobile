  ...
  render() {
    ...
    return (<div>
      ...
      <List renderHeader={() => 'CheckboxItem demo'}>
        {data.map(i => (
          <CheckboxItem prefixCls="yy-checkbox" key={i.value} onChange={() => this.onChange(i.value)}>
            {i.label}
          </CheckboxItem>
        ))}
      ...
      <Flex>
        <Flex.Item>
          <AgreeItem prefixCls="yy-checkbox" data-seed="logId" onChange={e => console.log('checkbox', e)}>
